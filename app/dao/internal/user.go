...
// UserColumns defines and stores column names for table admin_user.
...
var (
	// User is globally public accessible object for table admin_user operations.
	User = &UserDao{
